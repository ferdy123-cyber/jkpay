...
export interface AbsenKeluarProps {
  /**
 ...
 */
export const AbsenKeluar = observer(function AbsenKeluar(props: AbsenKeluarProps) {
  const { style } = props
  return (
    <>
      ...
      <ScrollView>
        ...
        <View style={styles.statusAbsenView}>
          ...
          >
            Kamu belum absen keluar nih, absen dulu yuk!
          </Text>
        </View>
